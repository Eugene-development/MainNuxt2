              ...
              <div>
                ...
                <div class="mt-4 space-y-4">
                  ...
                  <p class="text-xs flex">
                    <svg class="my-auto mr-2 text-cyan-700 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                  ...
                  <p class="text-xs flex">
                    <svg class="my-auto mr-2 text-cyan-700 w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                  ...
                  <a class="flex" href="https://vk.com/gost_remont_kvartir"
                     target="_blank">
                    <svg class="my-auto mr-2 text-cyan-700 w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="mt-4 space-y-4">
                  <div class="flow-root">
                    <NuxtLink
                      ...
                      <svg aria-hidden="true" class="flex-shrink-0 h-6 w-6 text-cyan-700" fill="none"
