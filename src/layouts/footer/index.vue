              ...
              <div>
                ...
                <div class="mt-4 space-y-4">
                  ...
                  <p class="text-sm flex">
                    <svg class="my-auto mr-2 text-cyan-700 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                  ...
                  <p class="text-sm flex">
                    <svg class="my-auto mr-2 text-cyan-700 w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                  ...
                  <a class="  flex" href="https://vk.com/gost_remont_kvartir"
                     target="_blank">
                    <svg class="my-auto mr-2 text-cyan-700 w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
